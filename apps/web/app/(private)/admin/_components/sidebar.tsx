export default function Sidebar(): JSX.Element {
  return (
    <>
      <div className="fixed inset-0 z-20 hidden transition-opacity bg-black" />
      <div className="fixed inset-y-0 -left-[256px] z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0">
        <div className="flex items-center justify-center mt-3">
          <div className="flex items-center text-secondary">
            ...
            <span className="mx-3 text-2xl font-semibold text-white">
              Admin
            </span>
          </div>
        </div>
